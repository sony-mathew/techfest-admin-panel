  ...
  if ( isset ( $_COOKIE['a3k12reg'] ) )
            {
                 ...
                 elseif ( isset ( $_GET['reg']) && $_GET['reg'] == 'cash')
                       {
                             if( isset($_POST['check']) && $_POST['check'] == '1')
                                 { 
                                     $page = str_replace('{main-content-right}', reg_cash_submit() , $page ) ;
                                 }
                             else
                                  {
                                     $page = str_replace('{main-content-right}', reg_cash() , $page ) ;
                                  }     
                       }      
...
//only for administrator
  ...
  elseif ( isset ( $_COOKIE['a3k12admin'] ) )
            {    
